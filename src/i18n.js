  ...
  resources: {
    ptBR: {
      translations: {
        ...
        "Encorajar e empoderar os Brasileiros a ter controle de suas finanças;":
          "Encorajar e empoderar os Brasileiros a terem controle de suas finanças;",
        ...
        "Confira de maneira fácil seu saldo e seus rendimentos.":
          "Confira de maneira fácil seu saldo e seus rendimentos.",
        ...
        "Conheça mais sobre as instituições ajudadas":
          "Conheça mais sobre as instituições ajudadas",
        A: "A",
    ...
    en: {
      translations: {
        ...
        Objetivos: "Goals",
        "Encorajar e empoderar os Brasileiros a ter controle de suas finanças;":
          "Encourage and empower Brazilians to take their finances in their own hands;",
        "Demonstrar o potencial de soluções financeiras alternativas;":
          "Demonstrate the potential of alternative financial solutions;",
        "Ajudar a arrecadar fundos à instituições de caridade destinadas às ações de cuidados aos maus tratos animais;":
        ...
        "Clique aqui para baixar o documento técnico oficial de nosso token.":
          "Click here to download our official white paper.",
        Amigável: "Friendly",
        "A carteira amiga do homem.": "Your new best friend!",
        "Sem burocracias, sem termos técnicos, sem configurações, baixou, usou.":
          "No bureaucracy, no technical terms, no configurations, just download and start using it.",
        ...
        "Envie e receba REAU de um jeito fácil, calculando o valor na sua moeda nativa.":
          "Transfer REAU easily, estimating the value in your preferred currency.",
        ...
        "Primeiro contato com ONGs para iniciar esforços de arrecadação de fundos de caridade":
          "First contact with NGOs to begin charity fundraising efforts within our community",
        ...
        "Listagem em rankings de moedas (CMC, CG e etc)":
          "Listing on coin rank listings (CMC, CG, etc)",
        "Novo site da Vira-Lata Finance e REAUPay":
          "New Viralata Finance website launch",
        "REAUPay v1 é lançado como uma maneira fácil de enviar e receber tokens, visualizar saldo e tokens ganhos, assim como carteira de fundos":
        ...
        "Parcerias com vendedores para mercados de NFT":
          "Beginning partnerships for the NFT market",
        "Parcerias com redes de suprimentos para pets, para distribuição de materiais para ONGs":
        ...
        "Lançamento do marketplace de NFTs com mercadorias de edição limitada da Vira-Lata Finance":
          "NFT marketplace with limited edition Vira-Lata merchandise",
        ...
        "Lançamento do 1o jogo Vira-Lata Finance com uso do $REAU como moeda virtual":
          "Caramel Game using $REAU as virtual currency",
        "O Vira-lata Finance foi inspirado pelo vira-lata caramelo e por milhares de outros vira-latas que vivem nas ruas do Brasil.":
        ...
        "Conheça mais sobre as instituições ajudadas":
          "Find out more about the institutions we’ve helped",
        A: "",
    ...
    es: {
      translations: {
        ...
        Objetivos: "Objetivos",
        "Encorajar e empoderar os Brasileiros a ter controle de suas finanças;":
          "Alentar y empoderar a los brasileños para que tengan control sobre sus finanzas;",
        "Demonstrar o potencial de soluções financeiras alternativas;":
          "Demostrar el potencial de soluciones financieras alternativas;",
        "Ajudar a arrecadar fundos à instituições de caridade destinadas às ações de cuidados aos maus tratos animais;":
        ...
        "Clique aqui para baixar o documento técnico oficial de nosso token.":
          "Haz Click para hacer el download del documento técnico oficial de nuestro Token.",
        Amigável: "Amigable",
        "A carteira amiga do homem.": "La billetera amiga del hombre!",
        "Sem burocracias, sem termos técnicos, sem configurações, baixou, usou.":
          "Sin burocracia, sin términos técnicos, sin configuraciones, descargás y usás.",
        "Seus rendimentos": "Tus Rendimientos",
        "Confira de maneira fácil seu saldo e seus rendimentos.":
          "Consultá tu saldo e ingresos fácilmente.",
        "Você pode destinar parte de seus rendimentos à instituições de caridade.":
          "Podés destinar parte de tus rendimientos a organizaciones benéficas.",
        "Envie e Receba": "Enviar y recibir",
        "Envie e receba REAU de um jeito fácil, calculando o valor na sua moeda nativa.":
          "Enviá y recibí REAU de forma sencilla, calculando el valor en su moneda nativa.",
        ...
        "Primeira listagem em uma corretora.":
          "Primera cotización en una Exchange.",
        "Auditoria(s) completas": "Auditoría(s) completa",
        "Listagem em rankings de moedas (CMC, CG e etc)":
          "Listado en el ranking de monedas (CMC, CG, etc.)",
        "Novo site da Vira-Lata Finance e REAUPay":
          "Nuevo sitio web de Vira-Lata Finance y REAUPay",
        "REAUPay v1 é lançado como uma maneira fácil de enviar e receber tokens, visualizar saldo e tokens ganhos, assim como carteira de fundos":
        ...
        "Parcerias com vendedores para mercados de NFT":
          "Asociaciones con vendedores para mercados NFT",
        "Parcerias com redes de suprimentos para pets, para distribuição de materiais para ONGs":
        ...
        "Lançamento do 1o jogo Vira-Lata Finance com uso do $REAU como moeda virtual":
          "Lanzamiento del primer juego Vira-Lata Finance usando $REAU como moneda virtual",
        "O Vira-lata Finance foi inspirado pelo vira-lata caramelo e por milhares de outros vira-latas que vivem nas ruas do Brasil.":
        ...
        "Conheça mais sobre as instituições ajudadas":
          "Más información sobre las instituciones asistidas",
        A: "",
